...
function Pipis:init(x, y)
    super.init(self, x, y, "battle/bullets/common/pipis/normal/pipis")
...
function Pipis:onYellowShot(shot, damage)
    ...
    if self.shot_health == 3 then
        self:setSprite("battle/bullets/common/pipis/normal/pipis_broken1")
    elseif self.shot_health == 2 then
        self:setSprite("battle/bullets/common/pipis/normal/pipis_broken2")
    elseif self.shot_health == 1 then
        self:setSprite("battle/bullets/common/pipis/normal/pipis_broken3")
...
function Pipis:destroy(shot)
    ...
    --[[for i=0,11 do
        local diamond = self.wave:spawnBullet("snep/diamond_white", self.x, self.y)
